...
public interface ResolutionStrategy {
    ...
    AnalysisType resolveClass(SerializableMethodSummary.ClassId classId);

    AnalysisMethod resolveMethod(AnalysisType clazz, SerializableMethodSummary.MethodId methodId);

    AnalysisMethod resolveMethod(SerializableMethodSummary.MethodId methodId);

    AnalysisField resolveField(AnalysisType clazz, SerializableMethodSummary.FieldId fieldId);
